...
package
{
	...
	/**	
	 * Sample application for using the ContentProvider Native Extension
	 */
	public class TestContentProvider extends Sprite
	{
		...
		private function init( ):void
		{
			try
			{
				message( "ContentProvider Supported: " + ContentProvider.isSupported );
				message( "ContentProvider Version:   " + ContentProvider.service.version );
